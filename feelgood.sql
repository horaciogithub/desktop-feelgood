...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2018 a las 13:45:56
...
('horacioram@gmail.com', 'hombre', 30, '1.82', '76.000', 2, 1);
...
(6, 'Juan Armas', 'dsdsdsd'),
(7, 'Alberto armas', 'dssss');
...
(2, NULL, 'anaerobico', '2018-05-27', '2018-06-27', '00:40:00');
...
INSERT INTO `usuario_registrado` (`email`, `contrasena`, `nombre`, `apellidos`, `fecha_nacimiento`, `tipo`, `foto`) VALUES
('erojasan@gmail.com', '111111', 'Estefanía', 'Rojas', '1987-11-22', 'entrenador', 'F:*CFS-DAW*PRO*PROYECTO PRO*feelgoodEscritorio*src*images*foto_perfil*DSCN0260 - copia.JPG'),
('horacioram@gmail.com', '111111', 'Horacio', 'Ramírez', '1987-11-22', 'cliente', 'F:*CFS-DAW*PRO*PROYECTO PRO*feelgoodEscritorio*src*images*foto_perfil*foto.jpg'),
('saulo@gmail.com', '111111', 'Saulo', 'Poveda', '1998-01-01', 'nutricionista', 'F:*CFS-DAW*PRO*PROYECTO PRO*feelgoodEscritorio*src*images*foto_perfil*saulo.jpg');
...
(9, 'horacioram@gmail.com', 0, '23:30:12', '2018-06-02'),
(10, 'horacioram@gmail.com', 0, '22:52:24', '2018-06-09'),
(11, 'horacioram@gmail.com', 0, '18:32:50', '2018-06-10'),
(12, 'horacioram@gmail.com', 1, '12:24:56', '2018-06-11');
...
--
ALTER TABLE `hilo_foro`
  MODIFY `id_hilo` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `vasos_agua`
  MODIFY `id_agua` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
